...
function AutocompleteItem({
  ...
  return (
    <AutocompletePrimitive.Item
      className={cn(
        "flex min-h-8 cursor-pointer select-none items-center rounded-sm px-2 py-1 text-base outline-none data-disabled:pointer-events-none data-disabled:cursor-not-allowed data-highlighted:bg-accent data-highlighted:text-accent-foreground data-disabled:opacity-64 sm:min-h-7 sm:text-sm",
        className,
      )}
