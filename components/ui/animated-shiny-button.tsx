  ...
  return (
    <>
      <style jsx>{`
        ...
        /* Retro Arcade theme adjustments - стили вынесены в globals.css для гарантированного применения */
      `}</style>
